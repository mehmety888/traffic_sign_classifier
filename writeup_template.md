...
As a first step, I decided to convert the images to grayscale because color of the image does not mean much to me when I'm classify a traffic sign. If I use RGB values, my model will try to learn, the color values of images too, which will increase complexity of my model.
